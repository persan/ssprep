...
"""
    ...
    def __init__(self, options):
        ...
        self.bin_dir         = os.path.join(os.path.dirname(CURDIR),"bin")
...
class Runner(object):
    ...
    def __init__(self, config):
        ...
        logging.debug("Running the testsuite")
    ...
    def __duration_report_rotate(self):
        ...
        for k in sorted(range(10), reverse=True):
            ...
            # print report_file , next_report_file
            if os.path.exists(report_file):
                if os.path.exists(next_report_file):
                    os.remove(next_report_file)
...
if __name__ == "__main__":
    main()
    import test_support
    if test_support.ErrorCount!= 0:
        sys.exit("Regresion failed")
